...
make_DHelper(F_R) {
  decode_op_fpr(s, id_src1, s->isa.instr.i.rs1, true);
  decode_op_fpr(s, id_src2, s->isa.instr.i.rs2, true);
...
make_DHelper(F_ld) {
  ...
  rtl_add(&id_src1->addr, &id_src1->val, &id_src2->val);
...
make_DHelper(F_st) {
  ...
  decode_op_fpr(s, id_dest, s->isa.instr.i.rs2, true);
}
...
make_DHelper(F_fpr_to_gpr){
  decode_op_fpr(s, id_src1, s->isa.instr.i.rs1, true);
  decode_op_fpr(s, id_src2, s->isa.instr.i.rs2, true);
  decode_op_r(id_dest, s->isa.instr.i.rd, false);
  decode_fp_width();
}
...
make_DHelper(F_gpr_to_fpr){
  decode_op_r(s, id_src1, s->isa.instr.i.rs1, true);
  decode_op_r(s, id_src2, s->isa.instr.i.rs2, true);
  decode_op_fpr(s, id_dest, s->isa.instr.i.rd, false);
  decode_fp_width();
}
...
make_DHelper(C_FSWSP) {
  ...
  decode_op_fpr(s, id_dest, decinfo.isa.instr.c_rs2, true);
...
make_DHelper(C_FLWSP) {
  ...
  decode_op_fpr(s, id_dest, decinfo.isa.instr.c_rd_rs1, true);
...
make_DHelper(C_FSW) {
  decode_op_r(s, id_src1, creg2reg(decinfo.isa.instr.c_rd_rs1_), true);
  ...
  decode_op_fpr(s, id_dest, creg2reg(decinfo.isa.instr.c_rs2_), true);
...
make_DHelper(C_FLW) {
  ...
  decode_op_fpr(s, id_dest, creg2reg(decinfo.isa.instr.c_rd_), false);
